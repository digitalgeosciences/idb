...
useEffect(() => {
  ...
  }, [programFilter, authorFilter, startYear, endYear, searchQuery]);
  ...
  const scopedStats = useMemo(() => {
    ...
    if (!programFilter && !authorFilter && from == null && to == null) return topicStats;
    ...
    for (const work of worksTable) {
      if (programFilter && work.program !== programFilter) continue;
  ...
  }, [programFilter, authorFilter, startYear, endYear, allYears]);
